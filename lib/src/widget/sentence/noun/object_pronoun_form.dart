...
class ObjectPronounForm extends StatefulWidget {
  final Widget settingsControl;
  final ObjectPronoun? pronoun;
  final void Function(ObjectPronoun?) setPronoun;

  const ObjectPronounForm({
    super.key,
  ...
  @override
  State<ObjectPronounForm> createState() => _PronounFormState();
}

class _PronounFormState extends State<ObjectPronounForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return ItemEditorLayout(
      ...
      body: [
        ...
        if (isFieldShown)
          ItemField<ObjectPronoun>(
            label: Label.personalPronoun,
            options: vocabularyRepository.objectPronouns(),
